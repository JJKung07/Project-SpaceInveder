...
public class Boss extends Pane {
    ...
    public Boss(int x, int y, int offsetX, int offsetY) {
        ...
        // Validate resource fetching
        InputStream imageStream = Launcher.class.getResourceAsStream("/se233/project2/Boss.png");
        if (imageStream == null) {
            throw new IllegalArgumentException("Boss image not found at specified path");
        }

        // Load image
        this.bossImg = new Image(imageStream);
